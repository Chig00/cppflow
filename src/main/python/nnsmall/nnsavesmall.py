...
def make_data(size):
    ...
    for i in range(size):
        ...
        labels.append(1 if data_point[0] >= THRESHOLDS[0]
                      and data_point[1] >= THRESHOLDS[1] else 0)
...
def main():
    ...
    The inputs are points in 2-dimensional space
     with co-ordinates in the range [0, 1].
    Points in the positive set have both co-ordinates in the range [0.5, 1]
     (i.e. they are in the top-right quadrant).
    """
